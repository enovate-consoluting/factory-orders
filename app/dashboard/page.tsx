    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-3 sm:p-4 md:p-6">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Here's what needs your attention</p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
          <div className="bg-white rounded-lg sm:rounded-xl shadow-lg border-2 border-amber-200 p-4 sm:p-6">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              ...
              {clientStats.pendingProducts > 0 && (
                <span className="px-2 py-1 bg-amber-500 text-white text-[10px] sm:text-xs font-bold rounded-full animate-pulse">
                  ACTION NEEDED
                </span>
              )}
            </div>
            <p className="text-xs sm:text-sm text-gray-500 mb-1">Awaiting Your Approval</p>
            <p className="text-2xl sm:text-3xl font-bold text-amber-600">{clientStats.pendingProducts}</p>
          </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-green-600">{clientStats.approvedProducts}</p>
          </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-blue-600">{clientStats.totalOrders}</p>
          </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mb-1">Pending Invoices</p>
            <p className="text-2xl sm:text-3xl font-bold text-purple-600">{clientStats.pendingInvoices}</p>
          </div>
        </div>

        {/* Orders Needing Attention */}
        <div className="bg-white rounded-lg sm:rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="p-4 sm:p-6 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200">
          ...
          <div className="p-4 sm:p-6">
            {recentOrders.length === 0 ? (
              <div className="text-center py-8 sm:py-12">
                ...
                <p className="text-sm sm:text-base text-gray-500">No orders need your attention right now</p>
              </div>
            ) : (
              <div className="space-y-2 sm:space-y-3">
                {recentOrders.map((order) => (
                  <Link
                    ...
                    className="block p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-amber-300 hover:bg-amber-50 transition-all"
                  >
    ...
    <div className="p-3 sm:p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200 shadow-sm">
          <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-2">Total Orders</h3>
          <p className="text-2xl sm:text-3xl font-bold text-gray-900">0</p>
        </div>
        
        <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200 shadow-sm">
          <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-2">Pending Approval</h3>
          <p className="text-2xl sm:text-3xl font-bold text-yellow-600">0</p>
        </div>
        
        <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200 shadow-sm">
          <h3 className="text-gray-500 text-xs sm:text-sm font-medium mb-2">Completed</h3>
          <p className="text-2xl sm:text-3xl font-bold text-green-600">0</p>
        </div>
      </div>

      <div className="mt-6 sm:mt-8 bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200 shadow-sm">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Welcome!</h2>
