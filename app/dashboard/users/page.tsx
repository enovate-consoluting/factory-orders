    ...
    <div className="p-3 sm:p-6">
            ...
            {(currentUser?.role === 'super_admin' || currentUser?.role === 'manufacturer') && (
              <div className="flex gap-2 pt-3 border-t border-gray-200">
                ...
                <button
                  ...
                  className="flex-1 px-3 py-2 text-sm bg-red-50 text-red-600 rounded-lg hover:bg-red-100 font-medium flex items-center justify-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {users.length > 0 && filteredUsers.length === 0 && searchQuery && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">No users match "{searchQuery}"</p>
          <button
            onClick={() => setSearchQuery('')}
