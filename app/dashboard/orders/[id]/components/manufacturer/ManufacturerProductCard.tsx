...
>(function ManufacturerProductCardV2(
  ...
  // When locked: gray out route button (not hidden to maintain alignment)
  const currentProductStatus = (product as any)?.product_status;
  const isProductLocked = currentProductStatus === 'delivered' || currentProductStatus === 'completed';
      ...
      <div className="p-2.5 sm:p-3 border-b-2 cursor-pointer bg-gray-50 border-gray-200" onClick={toggleExpanded}>
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {onRoute && (
              <button
                onClick={isProductLocked ? undefined : (e) => { e.stopPropagation(); onRoute(product); }}
            ...
            {/* Lock/Unlock button - hidden when product is delivered/completed */}
            {!isProductLocked && (
              <button
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <textarea
            ...
            rows={3}
            disabled={isProductLocked}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 text-sm placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none disabled:bg-gray-100 disabled:cursor-not-allowed"
          />
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isProductLocked}
                className="w-full pl-8 pr-3 py-2 border border-gray-200 rounded-lg bg-white text-gray-900 text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g., 25"
                disabled={isProductLocked}
                className="w-full pl-8 pr-12 py-2 border border-gray-200 rounded-lg bg-white text-gray-900 text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
              />
        ...
        <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between mb-3">
            ...
            {allOrderProducts && allOrderProducts.length > 1 && !isProductLocked && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={isProductLocked || !!(product as any).shipping_link_note}
                  className="w-full pl-8 pr-3 py-2 border border-gray-200 rounded-lg bg-white text-gray-900 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed"
                />
              </div>
            </div>
            <div>
        ...
        {/* Save button - hidden when product is locked */}
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Edit variants button - hidden when product is locked */}
              {!editingVariants && !isProductLocked && (
                <button
