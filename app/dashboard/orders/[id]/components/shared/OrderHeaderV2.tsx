...
export function OrderHeaderV2({
  ...
  // Layout toggle state
  const [useNewLayout, setUseNewLayout] = useState(true); // Default true since we're on V2
    ...
    <>
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4">
          ...
          {/* Row 1: Title + Status + Layout Toggle + Total/Paid */}
          <div className="flex items-start justify-between gap-3 mb-4">
            ...
            {/* Right: Layout Toggle + Total/Paid */}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                      useNewLayout ? 'bg-blue-600' : 'bg-gray-300'
                    }`}
                    role="switch"
                  ...
                  <span className={`text-xs font-medium transition-colors ${useNewLayout ? 'text-blue-600' : 'text-gray-400'}`}>
                    New
                  </span>
                </div>
              )}
